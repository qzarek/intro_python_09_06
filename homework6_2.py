...
new_list_t1 = []
for index_t1, value_t1 in enumerate(my_list_t1):
    if index_t1 % 2 != 0:
        new_list_t1.append(value_t1[::-1])
    else:
        new_list_t1.append(value_t1)
# print(new_list_t1)
...
new_list_t2 = []
for value_t2 in my_list_t2:
    if value_t2[0] == 'a':
        new_list_t2.append(value_t2)
# print(new_list_t2)
...
new_list_t3 = []
for value_t3 in my_list_t3:
    if 'a' in value_t3:
        new_list_t3.append(value_t3)
# print(new_list_t3)
...
new_list_t4 = []
for value_t4 in my_list_t4:
    if type(value_t4) == str:
        new_list_t4.append(value_t4)
# print(new_list_t4)
